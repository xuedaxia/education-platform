  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="off" label-position="left">
     ...
     <el-form-item prop="confirm">
      ...
      <el-button :loading="loading" type="success" style="width:35%;margin-bottom:30px;margin-left:120px;" @click.native.prevent="handleRegister">注册</el-button>
      <router-link :to="'/login'">
      <el-button :loading="loading" type="info" style="margin-bottom:30px;margin-left:50px;" >返回登录</el-button>
      </router-link>
      <!-- <div class="tips">
...
import regist from '@/api/edu/register'
    ...
    handleRegister() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          regist.register(this.loginForm).then(() => {
            this.$message({
            type:'success',
            message:'注册成功'
            })
